...
questions_list.append(
        Question('Сколько зубов у человека?', '32', '33', '17', '15'))
questions_list.append(
        Question('Какого Iphone не существует?', '15', '14', 'Pro Max', 'Синий'))
questions_list.append(
        Question('Вечер в хату..', 'Басота', 'Тюрки', 'Иглу', 'Бандерлоги'))
questions_list.append(
        Question('Как называют программиста?', 'Программист', 'Айтишник', 'Испанец', 'Буквари'))
questions_list.append(
        Question('Сколько букв в алфавите?', '33', '27', '32', '28'))
questions_list.append(
        Question('На сколько нужно умножить, чтобы узнать ее человеческий образ?', '3', '2', '7', '4'))
questions_list.append(
        Question('Жигули - это  ', 'И то и другое', 'Машина', 'Имя', 'Консервная банка с гайками'))
questions_list.append(
        Question('Macan - это', 'И то и другое', 'Рэпер', 'Автомобиль марки Porshe', 'Mersedes'))
questions_list.append(
        Question('Opel  или....', 'Opel', 'Apel', 'Olen', 'aiplE'))
questions_list.append(
        Question('Как правильно:', 'Иммунитет', 'Имунитет', 'Имуннитет', 'Имунетет'))
questions_list.append(
        Question('Ганвест - это', 'И то и другое', 'Рэпер', 'Персонаж из майна', 'Белый жирдяй:]'))
questions_list.append(
        Question('Mersedes  или....', 'Mersedes', 'Mercedec', 'Mersebes', 'Mers'))
